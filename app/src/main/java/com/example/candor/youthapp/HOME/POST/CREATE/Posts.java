package com.example.candor.youthapp.HOME.POST.CREATE;
...
public class Posts {
    ...
    public Posts(String uid, String time_and_date, String caption, String post_image_url, String like_cnt, String comment_cnt , String  location , String post_push_id , long timestamp) {
